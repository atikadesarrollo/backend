...
@bp_facturacion.route('/query', methods=['GET'])
def query_facturacion():
    ...
    if fecha_inicio and fecha_fin:
        try:
            ...
            if delta <= 30:
                ...
                tabla = 'DL_Facturacion_v_Media'
            elif delta <= 365:
                tabla = 'DL_Facturacion_v_Antiguo'
            else:
                tabla = 'DL_Facturacion_v_Completo'
        except:
            tabla = 'DL_Facturacion_v_Completo'
...
registrar_endpoints_kpis(bp_facturacion)
